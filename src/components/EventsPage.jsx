...
//               </p>
//             </div>
//             <DataPicker eventsData={eventsData} onFilterChange={handleFilterChange} />
//           </div>
...
//                                   height={16}
//                                 />
//                                 {event.event_status === 2 || event.event_status === "finished"
//                                   ? "finished"
//                                   : event.event_status === 1 || event.event_status === "expected"
//                                   ? "expected"
//                                   : event.event_status === 0 || event.event_status === "ongoing"
//                                   ? "ongoing"
//                                   : event.event_status}
//                               </span>
//                             </div>
...
//   // Statusu formatlaşdırmaq üçün funksiya
//   const formatStatus = (status) => {
//     if (status === 0 || status === "ongoing" || status === "0") return "ongoing";
//     if (status === 1 || status === "expected" || status === "1") return "expected";
//     if (status === 2 || status === "finished" || status === "2") return "finished";
//     return status; // Naməlum statuslar üçün
//   };
...
//               </p>
//             </div>
//             <DataPicker t={t} eventsData={eventsData} onFilterChange={handleFilterChange} />
//           </div>
