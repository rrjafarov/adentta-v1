...
async function fetchBrandCategories(t) {
  try {
    const { data } = await axiosInstance.get(`/page-data/brand-categories`, {
      cache: "no-store",
    });
...
// export default function BrandCategorySelect({ onChange, t }) { // onChange prop-u burada əlavə edilib
//   const [selectedOption, setSelectedOption] = useState(null);
//   const [options, setOptions] = useState([]);
