...
const ProductsPageHero = ({ t, productData, selectedCategory, subcategories }) => {
  const title = selectedCategory?.title || t?.productsPageAllEquipments || "All Equipments Category";
  const description = selectedCategory?.meta_description || t?.productsPageHeroText || "Lorem ipsum dolor sit amet";
