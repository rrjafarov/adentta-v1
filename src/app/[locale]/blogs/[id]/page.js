...
//   const blogDetail = blogsData.find((item) => item.id.toString() === slug);

//   if (!blogDetail) {
//     return <div>Career not found.</div>;
//   }

//   const otherBlogs = blogsData.filter((item) => item.id.toString() !== slug);
...
//         <BlogsDetailPage t={t}  blogDetail={blogDetail} otherBlogs={otherBlogs} />
